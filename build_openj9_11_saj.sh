...
ACMEAIR_CONTAINER_NAME="liberty-acmeair:openj9_11_myjdk"
DOCKERFILE="Dockerfile_openj9_11_acmeair_saj"
NET_NAME="my-net"
...
startMongo
if [[ $? -eq 0 ]]; then
  docker build -m=200m --network=$NET_NAME -f $DOCKERFILE -t $ACMEAIR_CONTAINER_NAME .
  stopMongo
else
